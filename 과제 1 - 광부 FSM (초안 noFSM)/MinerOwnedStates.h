...
// =========== 금 채굴 ===========
class Enter_GoldMine_And_Dig_for_Nugget : public State
{
private:
...
// =========== 금 저축 ===========
class Visit_Bank_And_Deposit_Gold : public State
{
private:
...
// =========== 피로 해소 ===========
class Go_Home_And_Sleep_til_Rested : public State
{
private:
...
// =========== 갈증 해소 ===========
class Quench_Thirst : public State
{
private:
	Quench_Thirst(){}
...
// =========== 굶주림 해소 ===========
class Relieve_Hunger : public State
{
private:
	Relieve_Hunger(){}
